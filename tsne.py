...
from cifar10_dataset import Cifar10Dataset, collate_skip_empty, colors_per_class
...
def get_features(dataset, batch, num_images):
    ...
    dataset = Cifar10Dataset(dataset, num_images)
...
def visualize_tsne_images(tx, ty, images, labels, plot_size=1000, max_image_size=100):
    ...
    #plt.show()
    fig.savefig('tsne_img.png', dpi=fig.dpi)
...
def visualize_tsne_points(tx, ty, labels):
    ...
    #plt.show()
    fig.savefig('tsne_points.png', dpi=fig.dpi)

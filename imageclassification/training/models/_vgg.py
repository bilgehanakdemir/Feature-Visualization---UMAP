...
class VGGBNDrop(nn.Module):
    ...
    def __init__(self, num_classes, init_weights=True):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, padding=1, stride=1),  #3 has changed to 1 for grayscale
            nn.BatchNorm2d(64),
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(2048, 512),   #first index 512 changed to 2048 for grayscale image

...
if __name__ == "__main__":
    ...
    for file in model_files:
      ...
      net.load_state_dict(torch.load(file, map_location=lambda storage, location: storage))
      predict, gt = eval_model(net, device, eval_loader)
...
#   print(i)
#print(all_predictions[:,0:50])
#vote =  np.asarray([np.bincount(all_predictions[i]) for i in range(all_predictions.shape[0:3])])
#print(vote.shape)
